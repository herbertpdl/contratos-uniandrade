					...
					<form action="Formulario/gerarPdf" method="POST">
						<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text" id="cep" name="cep" maxlength="9" class="form-control"  placeholder="00.000-000">
							</div>
							...
							<div class="form-group">
								...
								<input type="text" id="estado" name="estado" maxlength="2" class="form-control"  placeholder="Sigla do estado">
							</div>
							<div class="form-group">
